...
стенд. Оба проходят один и тот же набор тестов соответствия; ГОСТ дополнительно сверен с
контрольными примерами своих стандартов, подпись c25519 с RFC 8032.
